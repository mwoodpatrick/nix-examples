...
# [Rebuilding my NixOS config - Part 0: 🔧 NixOS Flakes & Git Basics: Everything You Need to Know](https://www.youtube.com/watch?v=43VvFgPsPtY)
# url = https://code.m3tam3re.com/m3tam3re/nixcfg.git
