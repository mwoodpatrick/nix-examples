...

{
  ...
  fileSystems."/mnt/wsl/projects" =
    { device = "/dev/disk/by-uuid/1a99092b-35fe-48e5-a3f0-9b9b4c71237a";
      fsType = "ext4";
    };
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/fe2bfb1e-d98e-4553-9c51-4bd55e3cada4";
      fsType = "ext4";
    };
  ...
  swapDevices =
    [ { device = "/dev/disk/by-uuid/9f6814c1-5ceb-4cf4-93fe-c38fd713aa8b"; }
    ];
